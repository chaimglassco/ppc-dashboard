...
- [ ] Confirm Daily Performance Quick Stats appears directly below the cards. Switch through Spend, PPC Sales, Total Sales, ACOS, and TACOS; reconcile aggregate selector values and every plotted completed day with Scale Insights for the applied dates and ASIN filter. Confirm today/future dates are absent and no extra request occurs when switching metrics.
