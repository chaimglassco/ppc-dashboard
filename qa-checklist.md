...
- [ ] Every imported campaign appears exactly once across the eight dropdowns. Verify the two Good rules, five Bad rules, Neutral, the inclusive 15% new-spend ACOS threshold, and precedence for Spend but No Sales in the previous week, current week, or both, followed by Lost Current-Week Sales and New Spend with high ACOS.
