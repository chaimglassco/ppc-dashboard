...
export type RichTextMark={type:"bold"|"italic"|"underline"}|{type:"link";attrs:{href:string}};
export type RichTextNode={type:string;text?:string;attrs?:{checked?:boolean;start?:number;textAlign?:TextAlignment};marks?:RichTextMark[];content?:RichTextNode[]};
