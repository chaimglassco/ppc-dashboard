...
- Deleted documents and categories retain `deletedAt` tombstones and remain inactive until explicit ADMIN recovery. An ADMIN-confirmed document purge removes the tombstone and content permanently while retaining its audit metadata. Pipeline backup restore merges records without tombstoning backup-absent or newer active documents and cannot recreate purged document IDs.
